...
def run_cnn(filter_size=2, top_k=5, full_cell=1024, iteration_num=1000):
    ...
    data.read_wordNet(r'D:\tianliuyang\D\MSRP_2018\data\wordnet.voc')
    data.read_word2vec_model(r'D:\tianliuyang\D\MSRP_2018\data\wiki_msrp100.vec')
    data.read_train_data(r'D:\tianliuyang\D\MSRP_2018\data\msr_paraphrase_train.txt')
    data.read_test_data(r'D:\tianliuyang\D\MSRP_2018\data\msr_paraphrase_test.txt')
...
print('拼命国恒交叉熵,AdamOptimizer 为什么还是学偏了啊！！！')
