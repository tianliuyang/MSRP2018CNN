...
def load_wiki():
    wiki_content = []
    with open(r'D:\tianliuyang\E\wiki_google\wikicorp.201004_sen.txt', 'r', encoding='utf-8') as fr:
        for line in fr:
...
if __name__ == '__main__':
    ...
    file_split.close()
    # model_out = '../W2c_Data/w2c.model'  # 生成并保存向量模型地址
    vec_out = '../data/wiki_msrp_300.vec'  # 保存单词向量地址

    model = Word2Vec(LineSentence('../data/temp_300.txt'), size=300, window=8, min_count=5,
